--[[
    ================================================================
    NEXZAN KEY SYSTEM - LOADSTRING LENGKAP
    Mirip desain gambar referensi (dark modern UI)
    Drag-able, kecil untuk mobil, rapi & enak dipandang
    Mode Single (auto-copy) / Multi (dropdown pilih link)
    ================================================================
    Upload ke repo: NexzanHub/UI_NexzanHub
    Branch: arena/019f9ebd-ui-nexzanhub
]]
...
local function ShowToast(parent, title, msg, duration, color)
    duration = duration or 2.5; color = color or Color3.fromRGB(124, 58, 237)
    local toast = Instance.new("Frame")
    toast.Name = "NexzanToast"; toast.Size = UDim2.fromOffset(0, 36)
    toast.Position = UDim2.new(0.5, 0, 0, 10); toast.AnchorPoint = Vector2.new(0.5, 0)
    toast.BackgroundColor3 = Color3.fromRGB(16, 16, 22); toast.BackgroundTransparency = 0.08
    toast.BorderSizePixel = 0; toast.ClipsDescendants = true; toast.ZIndex = 999; toast.Parent = parent
    ...
    local layout = Instance.new("UIListLayout", toast); layout.FillDirection = Enum.FillDirection.Horizontal
    layout.VerticalAlignment = Enum.VerticalAlignment.Center; layout.Padding = UDim.new(0, 6)
    local dot = Instance.new("Frame", toast); dot.Size = UDim2.fromOffset(5, 5)
...
function NexzanKeyUI:Create(cfg)
    ...
    HeaderLine.BorderSizePixel = 0; HeaderLine.BackgroundTransparency = 0.6
    ...
    IconFrame.BackgroundColor3 = c.accent; IconFrame.BackgroundTransparency = 0.1
    ...
    TitleLbl.TextSize = isCompact and 15 or 18; TitleLbl.TextXAlignment = Enum.TextXAlignment.Left
    ...
    SubLbl.TextColor3 = c.textDim; SubLbl.Font = Enum.Font.SourceSans
    SubLbl.TextSize = isCompact and 11 or 13; SubLbl.TextXAlignment = Enum.TextXAlignment.Left
    ...
    CloseBtn.TextColor3 = c.textMuted; CloseBtn.Font = Enum.Font.GothamBold
    CloseBtn.TextSize = isCompact and 14 or 16; CloseBtn.AutoButtonColor = false
    ...
    GKBSub.Name = "SubDisplay"; GKBSub.Size = UDim2.new(1, 0, 0, 18); GKBSub.Position = UDim2.new(0, 0, 0, 18)
    GKBSub.BackgroundTransparency = 1; GKBSub.Text = ""
    ...
    ResetBtn.MouseButton1Click:Connect(function()
        TextBox.Text = ""; CharCount.Text = "0/50"
        SetStatus("", c.text)
